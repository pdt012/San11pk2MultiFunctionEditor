namespace kmfe.Editor.ScenarioConfig.EditDialog
{
    partial class ArmyLevelEditDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            label4 = new Label();
            label5 = new Label();
            value_exp = new Forms.DecimalBox();
            value_tactic_chance = new Forms.DecimalBox();
            value_stat_ratio = new Forms.DecimalBox();
        ...
        private Forms.DecimalBox value_exp;
        private Forms.DecimalBox value_tactic_chance;
        private Forms.DecimalBox value_stat_ratio;
