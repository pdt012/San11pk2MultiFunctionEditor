...
namespace kmfe.utils.bytesConverter
{
    public static class BytesConverter
    {
        ...
        public static void FromBytes(byte[] buffer, int startIndex, sbyte[] sbyteArray)
        {
        ...
        public static void FromBytes(byte[] buffer, int startIndex, IBytesConvertable target)
        {
            ...
            byte[] bufferForTarget = new byte[target.Size];
            Array.Copy(buffer, startIndex, bufferForTarget, 0, bufferForTarget.Length);
        ...
        public static void ToBytes(byte[] buffer, int startIndex, sbyte[] sbyteArray)
        {
            byte[] byteArray = new byte[sbyteArray.Length];
            for (int i = 0; i < sbyteArray.Length; i++)
