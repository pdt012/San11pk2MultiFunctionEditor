...
namespace kmfe.utils
{
    ...
    {
        static readonly Dictionary<ushort, char?> pk2uniMap = new Dictionary<ushort, char?>();
        static readonly Dictionary<char, ushort> uni2pkMap = new Dictionary<char, ushort>();
            ...
            while (i < pkBytes.Length)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        char? c = pk2uniMap.ContainsKey(jisCode) ? pk2uniMap[jisCode] : '?';
                        if (c != null)
                            result += c;
                    }
                }
