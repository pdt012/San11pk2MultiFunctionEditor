...
namespace kmfe.core
{
    public class PathXmlHelper
    {
        ...
        static readonly Dictionary<string, int> keyToCityIdDict = new Dictionary<string, int>();
        static readonly Dictionary<string, int> KeyToRouteDict = new Dictionary<string, int>();
        ...
        public int[] GetDistance(CityLike baseCityLike)
        {
            ...
            Queue<CityLike> queue = new Queue<CityLike>();
        ...
        public void Load(string xmlPath)
        {
            ...
            {
                if (!(cityNode is XmlElement))  // 过滤注释
                    continue;
